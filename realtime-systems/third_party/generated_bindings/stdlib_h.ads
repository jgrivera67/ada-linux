...
with System;
with arm_linux_gnueabihf_bits_floatn_common_h;
with Interfaces.C.Extensions;
with stddef_h;
with arm_linux_gnueabihf_bits_types_locale_t_h;
with arm_linux_gnueabihf_bits_stdint_intn_h;
...
package stdlib_h is
  ...
  -- Likewise for '_FloatN' and '_FloatNx'.
   function strtof32 (uu_nptr : Interfaces.C.Strings.chars_ptr; uu_endptr : System.Address) return arm_linux_gnueabihf_bits_floatn_common_h.u_Float32;  -- /usr/include/stdlib.h:140
   pragma Import (C, strtof32, "strtof32");

   function strtof64 (uu_nptr : Interfaces.C.Strings.chars_ptr; uu_endptr : System.Address) return arm_linux_gnueabihf_bits_floatn_common_h.u_Float64;  -- /usr/include/stdlib.h:146
   pragma Import (C, strtof64, "strtof64");

   function strtof32x (uu_nptr : Interfaces.C.Strings.chars_ptr; uu_endptr : System.Address) return arm_linux_gnueabihf_bits_floatn_common_h.u_Float32x;  -- /usr/include/stdlib.h:158
  ...
  -- Convert a floating-point number to a string.
   ...
   function strfromf32
     (uu_dest : Interfaces.C.Strings.chars_ptr;
      uu_size : stddef_h.size_t;
      uu_format : Interfaces.C.Strings.chars_ptr;
      uu_f : arm_linux_gnueabihf_bits_floatn_common_h.u_Float32) return int;  -- /usr/include/stdlib.h:232
   ...
   function strfromf64
     (uu_dest : Interfaces.C.Strings.chars_ptr;
      uu_size : stddef_h.size_t;
      uu_format : Interfaces.C.Strings.chars_ptr;
      uu_f : arm_linux_gnueabihf_bits_floatn_common_h.u_Float64) return int;  -- /usr/include/stdlib.h:238
   ...
   function strfromf32x
     (uu_dest : Interfaces.C.Strings.chars_ptr;
      uu_size : stddef_h.size_t;
      uu_format : Interfaces.C.Strings.chars_ptr;
      uu_f : arm_linux_gnueabihf_bits_floatn_common_h.u_Float32x) return int;  -- /usr/include/stdlib.h:250
  ...
  --   by the POSIX.1-2008 extended locale API.
   ...
   function strtol_l
     (uu_nptr : Interfaces.C.Strings.chars_ptr;
      uu_endptr : System.Address;
      uu_base : int;
      uu_loc : arm_linux_gnueabihf_bits_types_locale_t_h.locale_t) return long;  -- /usr/include/stdlib.h:274
   ...
   function strtoul_l
     (uu_nptr : Interfaces.C.Strings.chars_ptr;
      uu_endptr : System.Address;
      uu_base : int;
      uu_loc : arm_linux_gnueabihf_bits_types_locale_t_h.locale_t) return unsigned_long;  -- /usr/include/stdlib.h:278
   ...
   function strtoll_l
     (uu_nptr : Interfaces.C.Strings.chars_ptr;
      uu_endptr : System.Address;
      uu_base : int;
      uu_loc : arm_linux_gnueabihf_bits_types_locale_t_h.locale_t) return Long_Long_Integer;  -- /usr/include/stdlib.h:284
   ...
   function strtoull_l
     (uu_nptr : Interfaces.C.Strings.chars_ptr;
      uu_endptr : System.Address;
      uu_base : int;
      uu_loc : arm_linux_gnueabihf_bits_types_locale_t_h.locale_t) return Extensions.unsigned_long_long;  -- /usr/include/stdlib.h:290
   pragma Import (C, strtoull_l, "strtoull_l");

   function strtod_l
     (uu_nptr : Interfaces.C.Strings.chars_ptr;
      uu_endptr : System.Address;
      uu_loc : arm_linux_gnueabihf_bits_types_locale_t_h.locale_t) return double;  -- /usr/include/stdlib.h:295
   pragma Import (C, strtod_l, "strtod_l");

   function strtof_l
     (uu_nptr : Interfaces.C.Strings.chars_ptr;
      uu_endptr : System.Address;
      uu_loc : arm_linux_gnueabihf_bits_types_locale_t_h.locale_t) return float;  -- /usr/include/stdlib.h:299
   pragma Import (C, strtof_l, "strtof_l");

   function strtold_l
     (uu_nptr : Interfaces.C.Strings.chars_ptr;
      uu_endptr : System.Address;
      uu_loc : arm_linux_gnueabihf_bits_types_locale_t_h.locale_t) return long_double;  -- /usr/include/stdlib.h:303
   pragma Import (C, strtold_l, "strtold_l");

   function strtof32_l
     (uu_nptr : Interfaces.C.Strings.chars_ptr;
      uu_endptr : System.Address;
      uu_loc : arm_linux_gnueabihf_bits_types_locale_t_h.locale_t) return arm_linux_gnueabihf_bits_floatn_common_h.u_Float32;  -- /usr/include/stdlib.h:316
   pragma Import (C, strtof32_l, "strtof32_l");

   function strtof64_l
     (uu_nptr : Interfaces.C.Strings.chars_ptr;
      uu_endptr : System.Address;
      uu_loc : arm_linux_gnueabihf_bits_types_locale_t_h.locale_t) return arm_linux_gnueabihf_bits_floatn_common_h.u_Float64;  -- /usr/include/stdlib.h:323
   pragma Import (C, strtof64_l, "strtof64_l");

   function strtof32x_l
     (uu_nptr : Interfaces.C.Strings.chars_ptr;
      uu_endptr : System.Address;
      uu_loc : arm_linux_gnueabihf_bits_types_locale_t_h.locale_t) return arm_linux_gnueabihf_bits_floatn_common_h.u_Float32x;  -- /usr/include/stdlib.h:337
  ...
  -- Front pointer.
   type random_data is record
      fptr : access arm_linux_gnueabihf_bits_stdint_intn_h.int32_t;  -- /usr/include/stdlib.h:425
      rptr : access arm_linux_gnueabihf_bits_stdint_intn_h.int32_t;  -- /usr/include/stdlib.h:426
      state : access arm_linux_gnueabihf_bits_stdint_intn_h.int32_t;  -- /usr/include/stdlib.h:427
      ...
      end_ptr : access arm_linux_gnueabihf_bits_stdint_intn_h.int32_t;  -- /usr/include/stdlib.h:431
   end record;
  ...
  -- Pointer behind state table.
   function random_r (uu_buf : access random_data; uu_result : access arm_linux_gnueabihf_bits_stdint_intn_h.int32_t) return int;  -- /usr/include/stdlib.h:434
  ...
  -- Allocate NMEMB elements of SIZE bytes each, all initialized to 0.
   function calloc (uu_nmemb : stddef_h.size_t; uu_size : stddef_h.size_t) return System.Address;  -- /usr/include/stdlib.h:541
  ...
  --   between objects pointed by the old and new pointers.
   ...
   function realloc (uu_ptr : System.Address; uu_size : stddef_h.size_t) return System.Address;  -- /usr/include/stdlib.h:549
  ...
  --   between objects pointed by the old and new pointers.
   ...
   function reallocarray
     (uu_ptr : System.Address;
      ...
      uu_size : stddef_h.size_t) return System.Address;  -- /usr/include/stdlib.h:558
  ...
  -- Allocate SIZE bytes on a page boundary.  The storage cannot be freed.
   function valloc (uu_size : stddef_h.size_t) return System.Address;  -- /usr/include/stdlib.h:572
  ...
  -- Allocate memory of SIZE bytes with an alignment of ALIGNMENT.
   function posix_memalign
     (uu_memptr : System.Address;
      ...
      uu_size : stddef_h.size_t) return int;  -- /usr/include/stdlib.h:577
   pragma Import (C, posix_memalign, "posix_memalign");

  -- ISO C variant of aligned allocation.
   function aligned_alloc (uu_alignment : stddef_h.size_t; uu_size : stddef_h.size_t) return System.Address;  -- /usr/include/stdlib.h:583
  ...
  --   __THROW.
   ...
   function c_system (uu_command : Interfaces.C.char_array) return int;  -- /usr/include/stdlib.h:781
  ...
  --   buffers.
   ...
   function ecvt_r
     (uu_value : double;
      ...
      uu_len : stddef_h.size_t) return int;  -- /usr/include/stdlib.h:899
   ...
   function qecvt_r
     (uu_value : long_double;
      ...
      uu_sign : access int;
      uu_buf : Interfaces.C.Strings.chars_ptr;
      uu_len : stddef_h.size_t) return int;  -- /usr/include/stdlib.h:906
  ...
  --   in S, which is no longer than N.
   ...
   function mblen (uu_s : Interfaces.C.Strings.chars_ptr; uu_n : stddef_h.size_t) return int;  -- /usr/include/stdlib.h:919
  ...
  --   putting its `wchar_t' representation in *PWC.
   ...
   function mbtowc
     (uu_pwc : access wchar_t;
      ...
      uu_n : stddef_h.size_t) return int;  -- /usr/include/stdlib.h:922
  ...
  -- Convert a multibyte string to a wide char string.
   function mbstowcs
     (uu_pwcs : access wchar_t;
      uu_s : Interfaces.C.Strings.chars_ptr;
      uu_n : stddef_h.size_t) return stddef_h.size_t;  -- /usr/include/stdlib.h:930
  ...
  -- Return a master pseudo-terminal handle.
   function posix_openpt (uu_oflag : int) return int;  -- /usr/include/stdlib.h:965
  ...
  -- Chown the slave to the calling user.
   function grantpt (uu_fd : int) return int;  -- /usr/include/stdlib.h:973
   pragma Import (C, grantpt, "grantpt");

  -- Release an internal lock so the slave can be opened.
  --   Call after grantpt().

   function unlockpt (uu_fd : int) return int;  -- /usr/include/stdlib.h:977
  ...
  --   The returned storage is good until the next call to this function.
   ...
   function ptsname (uu_fd : int) return Interfaces.C.Strings.chars_ptr;  -- /usr/include/stdlib.h:982
  ...
  --   Return 0 on success, otherwise an error number.
   ...
   function ptsname_r
     (uu_fd : int;
      uu_buf : Interfaces.C.Strings.chars_ptr;
      uu_buflen : stddef_h.size_t) return int;  -- /usr/include/stdlib.h:989
   pragma Import (C, ptsname_r, "ptsname_r");

  -- Open a master pseudo terminal and return its file descriptor.
   function getpt return int;  -- /usr/include/stdlib.h:993
  ...
  --   three, but may be less than NELEM), or -1 if an error occurred.
   ...
   function getloadavg (uu_loadavg : access double; uu_nelem : int) return int;  -- /usr/include/stdlib.h:1000
